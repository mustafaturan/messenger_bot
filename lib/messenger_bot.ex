defmodule MessengerBot do
  ...
  """
  @spec upload_attachment(page_ref(), Map.t()) :: res()
  @spec upload_attachment(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec create_message_creative(page_ref(), list(Map.t())) :: res()
  ...
  """
  @spec broadcast_message(page_ref(), Map.t()) :: res()
  @spec broadcast_message(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec list_custom_labels(page_ref(), {fields(), cursor()}) :: res()
  @spec list_custom_labels(page_ref(), {fields(), cursor()}, tx_id()) :: res()
  ...
  """
  @spec fetch_custom_label(page_ref(), {label_id(), list()}) :: res()
  @spec fetch_custom_label(page_ref(), {label_id(), list()}, tx_id()) :: res()
  ...
  """
  @spec create_custom_label(page_ref(), Map.t()) :: res()
  @spec create_custom_label(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec delete_custom_label(page_ref(), label_id()) :: res()
  @spec delete_custom_label(page_ref(), label_id(), tx_id()) :: res()
  ...
  """
  @spec label_user(page_ref(), {integer(), Map.t()}) :: res()
  @spec label_user(page_ref(), {integer(), Map.t()}, tx_id()) :: res()
  ...
  """
  @spec unlabel_user(page_ref(), {integer(), Map.t()}) :: res()
  @spec unlabel_user(page_ref(), {integer(), Map.t()}, tx_id()) :: res()
  ...
  """
  @spec list_custom_labels_of_user(page_ref(), {psid(), cursor()}) :: res()
  @spec list_custom_labels_of_user(page_ref(), {psid(), cursor()}, tx_id()) :: res()
  ...
  """
  @spec pass_thread_control(page_ref(), Map.t()) :: res()
  @spec pass_thread_control(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec take_thread_control(page_ref(), Map.t()) :: res()
  @spec take_thread_control(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec request_thread_control(page_ref(), Map.t()) :: res()
  @spec request_thread_control(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec fetch_secondary_receivers(page_ref(), fields()) :: res()
  @spec fetch_secondary_receivers(page_ref(), fields(), tx_id()) :: res()
  ...
  """
  @spec fetch_ids_for_page(page_ref(), {psid(), cursor()}) :: res()
  @spec fetch_ids_for_page(page_ref(), {psid(), cursor()}, tx_id()) :: res()
  ...
  """
  @spec fetch_ids_for_app(page_ref(), {psid(), cursor()}) :: res()
  @spec fetch_ids_for_app(page_ref(), {psid(), cursor()}, tx_id()) :: res()
  def fetch_ids_for_app({app_id, nil}, {psid, cursor}, tx_id \\ nil) do
    params = [
      app: app_id,
  ...
  """
  @spec create_messenger_code(page_ref(), Map.t()) :: res()
  @spec create_messenger_code(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec fetch_messaging_feature_review(page_ref()) :: res()
  @spec fetch_messaging_feature_review(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_insights(page_ref(), {metrics(), integer(), integer()}) :: res()
  @spec fetch_insights(page_ref(), {metrics(), integer(), integer()}, tx_id()) :: res()
  ...
  """
  @spec set_account_linking_url(page_ref(), String.t()) :: res()
  @spec set_account_linking_url(page_ref(), String.t(), tx_id()) :: res()
  ...
  """
  @spec reset_account_linking_url(page_ref()) :: res()
  @spec reset_account_linking_url(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_account_linking_url(page_ref()) :: res()
  @spec fetch_account_linking_url(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_get_started(page_ref()) :: res()
  @spec set_get_started(page_ref(), tx_id()) :: res()
  ...
  """
  @spec reset_get_started(page_ref()) :: res()
  @spec reset_get_started(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_get_started(page_ref()) :: res()
  @spec fetch_get_started(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_greeting(page_ref(), list(Map.t())) :: res()
  @spec set_greeting(page_ref(), list(Map.t()), tx_id()) :: res()
  ...
  """
  @spec reset_greeting(page_ref()) :: res()
  @spec reset_greeting(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_greeting(page_ref()) :: res()
  @spec fetch_greeting(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_home_url(page_ref(), Map.t()) :: res()
  @spec set_home_url(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec reset_home_url(page_ref()) :: res()
  @spec reset_home_url(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_home_url(page_ref()) :: res()
  @spec fetch_home_url(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_payment_settings(page_ref(), Map.t()) :: res()
  @spec set_payment_settings(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec reset_payment_settings(page_ref()) :: res()
  @spec reset_payment_settings(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_payment_settings(page_ref()) :: res()
  @spec fetch_payment_settings(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_persistent_menu(page_ref(), list()) :: res()
  @spec set_persistent_menu(page_ref(), list(), tx_id()) :: res()
  ...
  """
  @spec reset_persistent_menu(page_ref()) :: res()
  @spec reset_persistent_menu(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_persistent_menu(page_ref()) :: res()
  @spec fetch_persistent_menu(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_target_audience(page_ref(), Map.t()) :: res()
  @spec set_target_audience(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec reset_target_audience(page_ref()) :: res()
  @spec reset_target_audience(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_target_audience(page_ref()) :: res()
  @spec fetch_target_audience(page_ref(), tx_id()) :: res()
  ...
  """
  @spec set_whitelisted_domains(page_ref(), domains()) :: res()
  @spec set_whitelisted_domains(page_ref(), domains(), tx_id()) :: res()
  ...
  """
  @spec reset_whitelisted_domains(page_ref()) :: res()
  @spec reset_whitelisted_domains(page_ref(), tx_id()) :: res()
  ...
  """
  @spec fetch_whitelisted_domains(page_ref()) :: res()
  @spec fetch_whitelisted_domains(page_ref(), tx_id()) :: res()
  ...
  """
  @spec send_message(page_ref(), Map.t()) :: res()
  @spec send_message(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec unlink_account(page_ref(), Map.t()) :: res()
  @spec unlink_account(page_ref(), Map.t(), tx_id()) :: res()
  ...
  """
  @spec fetch_user_profile(page_ref(), {psid(), fields()}) :: res()
  @spec fetch_user_profile(page_ref(), {psid(), fields()}, tx_id()) :: res()
